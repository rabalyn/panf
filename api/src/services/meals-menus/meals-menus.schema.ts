...
export const mealsMenusDataSchema = Type.Pick(mealsMenusSchema, ['mealId', 'menuId'], {
  $id: 'MealsMenusData'
})
...
export const mealsMenusQueryProperties = Type.Pick(mealsMenusSchema, ['id', 'mealId', 'menuId'])
